...
//  prox_iMuzic
//
//  Created by Nguyen Trung Hieu on 5/17/20.
...
class YoutubePlayer: UIView {
    ...
    class func createMyClassView() -> YoutubePlayer {
        let myClassNib = UINib(nibName: "YoutubePlayer", bundle: nil)
        return myClassNib.instantiate(withOwner: nil, options: nil)[0] as! YoutubePlayer
    }
